...
//       subLinks: [
//         { name: "eBook", path: "/" },
//         { name: "Blog Library", path: "/" },
//         { name: "Brochures", path: "/" },
//         { name: "Calculator", path: "/" },
//         { name: "FAQs", path: "/" },
//         { name: "One Pagers", path: "/" },
//         { name: "Papers", path: "/" },
//         { name: " Photo Gallery", path: "/" },
//         { name: " Video / Presentation", path: "/" },
//       ],
//     },
//     {
//       name: "Contact",
...
//                   <ul
//                     key={item.name}
//                     className="flex flex-row gap-3 mx-3 transition-all duration-200"
//                   >
//                     {item.subLinks.map((subLink) => (
//                       <li
//                         key={subLink.name}
...
export default function Navbar() {
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subLinks: [
        { name: "AI and Machine Learning", path: "/solutions/consulting" },
        { name: "Blockchain Computing", path: "/solutions/custom-software" },
        { name: "Enterprise / Cloud / Hyperscale", path: "/" },
        { name: "Edge", path: "/" },
        { name: "High-Performance Computing", path: "/" },
      ],
    },
    {
      name: "Products",
    ...
    },
    {
      ...
      path: "/partners",
      subLinks: [
        { name: "ITE and Solutions Providers", path: "/" },
        { name: "GRC ElectroSafe® Fluid Partners", path: "/" },
      ],
    },
    {
      name: "Company",
  ...
  return (
    <nav className="w-full border-b">
      <DesktopNav navItems={navItems} navItemsSec={navItemsSec} />
      <MobileNav navItems={navItems} navItemsSec={navItemsSec} />
    </nav>
  );
}
